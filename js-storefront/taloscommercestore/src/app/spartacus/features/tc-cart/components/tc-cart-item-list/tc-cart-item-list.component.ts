...
@Component({
  ...
  templateUrl: './tc-cart-item-list.component.html',
  styleUrls: ['./tc-cart-item-list.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class TcCartItemListComponent implements OnInit, OnDestroy {
  ...
  productSelectedArray: OrderEntry[] = [];
  ...
  onProductPressed(productSelected: OrderEntry, checked: boolean){
    if (checked) {
      this.productSelectedArray.push(productSelected);
    } else {
      this.productSelectedArray.splice(this.productSelectedArray.indexOf(productSelected), 1);
    }
  }
