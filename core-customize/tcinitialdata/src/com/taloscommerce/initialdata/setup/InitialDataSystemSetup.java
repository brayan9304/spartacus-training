 ...
 */
package com.taloscommerce.initialdata.setup;
...
import com.taloscommerce.initialdata.constants.TcInitialDataConstants;
 ...
 */
@SystemSetup(extension = TcInitialDataConstants.EXTENSIONNAME)
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(InitialDataSystemSetup.class);

	public static final String TALOS_COMMERCE = "taloscommerce";
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		final var importData = new ImportData();
		importData.setProductCatalogName(TALOS_COMMERCE);
		importData.setContentCatalogNames(Collections.singletonList(TALOS_COMMERCE));
		importData.setStoreNames(Collections.singletonList(TALOS_COMMERCE));
